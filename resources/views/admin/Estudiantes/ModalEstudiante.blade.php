...
<div class="modal fade Estudiante bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form id="frmEstudianteModal"  class="needs-validation " action="{{route('estudiante.update',1)}}" method="POST">
                 @csrf
                 @method('PATCH')
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input id="nombreEstudiante" type="text" aria-label="First name" class="form-control" name="nombre" required>
                        <input id="apellidoEstudiante" type="text" aria-label="Last name" class="form-control" name="apellido" required>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-default">Cedula &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
                        </div>
                            <input id="cedulaEstudiante" type="text" class="form-control solonumeros" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="cedula" maxlength="10" required>
                    </div> 
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">Especialidades &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label>
                    </div>
                    <select  class="custom-select" id="cmbespecialidadE" name="idespecialidad" required>
